...
/**
 * This code is taken from openpgp.js and Enigmail
 *
...
var EXPORTED_SYMBOLS = ["OpenPGPWrapper"];
...
function initialize() {
  try {
    ...
    Services.scriptloader.loadSubScript("chrome://autocrypt/content/openpgp-lib.js", null, "UTF-8");
...
var OpenPGPWrapper = {
  ...
  funcs: {
    ...
    bytesToArmor: function(msgType, str) {
      ...
      const ARMOR_TYPE = OpenPGPWrapper.openpgp.enums.armor;
      ...
      let crc = OpenPGPWrapper.funcs.createcrc24(OpenPGPWrapper.funcs.str2Uint8Array(str));
